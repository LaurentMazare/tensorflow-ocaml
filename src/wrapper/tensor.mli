...
val set_float_array1 : (float, 'a) t -> float array -> unit
val set_float_array2 : (float, 'a) t -> float array array -> unit
val of_float_array1 : float array -> (float, 'a) Bigarray.kind -> (float, 'a) t
val of_float_array2 : float array array -> (float, 'a) Bigarray.kind -> (float, 'a) t
...
val to_float_array1 : (float, _) t -> float array
val to_float_array2 : (float, _) t -> float array array
val to_float_array3 : (float, _) t -> float array array array
