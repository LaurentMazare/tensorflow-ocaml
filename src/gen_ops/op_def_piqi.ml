...
and Tensor_shape_proto_dim : sig
  type t =
...
and Attr_value_list_value : sig
  ...
  Attr_value_list_value

and Name_attr_list : sig
  type t =
    { mutable name : string option
...
and Name_attr_list_attr_entry : sig
  type t =
    { mutable key : string option
    ; mutable value : Op_def_piqi.attr_value option
    }
end =
  Name_attr_list_attr_entry
...
and Op_list : sig
  type t = { mutable op : Op_def_piqi.op_def list }
end =
  Op_list
...
and parse_tensor_shape_proto x =
  ...
  { Tensor_shape_proto.dim = _dim; Tensor_shape_proto.unknown_rank = _unknown_rank }
...
and parse_tensor_shape_proto_dim x =
  ...
  Piqirun.check_unparsed_fields x;
  { Tensor_shape_proto_dim.size = _size; Tensor_shape_proto_dim.name = _name }
...
and parse_tensor_proto x =
  ...
  let _float_val, x =
    Piqirun.parse_packed_repeated_field 5 packed_parse_float32 parse_float32 x
  in
  let _double_val, x =
    Piqirun.parse_packed_repeated_field 6 packed_parse_float64 parse_float64 x
  in
  let _int_val, x =
    Piqirun.parse_packed_repeated_field
      7
      packed_parse_protobuf_int32
      parse_protobuf_int32
      x
  in
  let _string_val, x = Piqirun.parse_repeated_field 8 parse_binary x in
  let _scomplex_val, x =
    Piqirun.parse_packed_repeated_field 9 packed_parse_float32 parse_float32 x
  in
  let _int64_val, x =
    Piqirun.parse_packed_repeated_field
      10
      packed_parse_protobuf_int64
      parse_protobuf_int64
      x
  in
  let _bool_val, x =
    Piqirun.parse_packed_repeated_field 11 packed_parse_bool parse_bool x
  in
  let _dcomplex_val, x =
    Piqirun.parse_packed_repeated_field 12 packed_parse_float64 parse_float64 x
  in
  let _half_val, x =
    Piqirun.parse_packed_repeated_field
      13
      ...
      x
  in
  let _resource_handle_val, x =
    Piqirun.parse_repeated_field 14 parse_resource_handle x
  in
  Piqirun.check_unparsed_fields x;
...
and parse_attr_value_list_value x =
  ...
  in
  let _f, x =
    Piqirun.parse_packed_repeated_field 4 packed_parse_float32 parse_float32 x
  in
  let _b, x = Piqirun.parse_packed_repeated_field 5 packed_parse_bool parse_bool x in
  let _type_, x =
    Piqirun.parse_packed_repeated_field 6 packed_parse_data_type parse_data_type x
  in
...
and parse_name_attr_list x =
  ...
  Piqirun.check_unparsed_fields x;
  { Name_attr_list.name = _name; Name_attr_list.attr = _attr }
...
and parse_name_attr_list_attr_entry x =
  ...
  Piqirun.check_unparsed_fields x;
  { Name_attr_list_attr_entry.key = _key; Name_attr_list_attr_entry.value = _value }
...
and parse_op_deprecation x =
  ...
  Piqirun.check_unparsed_fields x;
  { Op_deprecation.version = _version; Op_deprecation.explanation = _explanation }
...
and gen__tensor_shape_proto code x =
  let _dim =
    Piqirun.gen_repeated_field 2 gen__tensor_shape_proto_dim x.Tensor_shape_proto.dim
  in
  let _unknown_rank =
    Piqirun.gen_optional_field 3 gen__bool x.Tensor_shape_proto.unknown_rank
  in
  Piqirun.gen_record code [ _dim; _unknown_rank ]

and gen__tensor_shape_proto_dim code x =
  let _size =
    Piqirun.gen_optional_field 1 gen__protobuf_int64 x.Tensor_shape_proto_dim.size
  in
...
and gen__resource_handle code x =
  ...
  let _container =
    Piqirun.gen_optional_field 2 gen__string x.Resource_handle.container
  in
  let _name = Piqirun.gen_optional_field 3 gen__string x.Resource_handle.name in
  let _hash_code =
    Piqirun.gen_optional_field 4 gen__uint64 x.Resource_handle.hash_code
  in
  let _maybe_type_name =
    Piqirun.gen_optional_field 5 gen__string x.Resource_handle.maybe_type_name
  in
...
and gen__tensor_proto code x =
  ...
  let _tensor_shape =
    Piqirun.gen_optional_field 2 gen__tensor_shape_proto x.Tensor_proto.tensor_shape
  in
  let _version_number =
    Piqirun.gen_optional_field 3 gen__protobuf_int32 x.Tensor_proto.version_number
  in
  let _tensor_content =
    Piqirun.gen_optional_field 4 gen__binary x.Tensor_proto.tensor_content
  in
  let _float_val =
    Piqirun.gen_packed_repeated_field 5 packed_gen__float32 x.Tensor_proto.float_val
  in
  let _double_val =
    Piqirun.gen_packed_repeated_field 6 packed_gen__float64 x.Tensor_proto.double_val
  in
  let _int_val =
    Piqirun.gen_packed_repeated_field 7 packed_gen__protobuf_int32 x.Tensor_proto.int_val
  in
  let _string_val = Piqirun.gen_repeated_field 8 gen__binary x.Tensor_proto.string_val in
  let _scomplex_val =
    Piqirun.gen_packed_repeated_field 9 packed_gen__float32 x.Tensor_proto.scomplex_val
  in
  let _int64_val =
    Piqirun.gen_packed_repeated_field
      10
      packed_gen__protobuf_int64
      x.Tensor_proto.int64_val
  in
  let _bool_val =
    Piqirun.gen_packed_repeated_field 11 packed_gen__bool x.Tensor_proto.bool_val
  in
  let _dcomplex_val =
    Piqirun.gen_packed_repeated_field 12 packed_gen__float64 x.Tensor_proto.dcomplex_val
  in
  let _half_val =
    Piqirun.gen_packed_repeated_field
      13
      packed_gen__protobuf_int32
      x.Tensor_proto.half_val
  in
  let _resource_handle_val =
    Piqirun.gen_repeated_field 14 gen__resource_handle x.Tensor_proto.resource_handle_val
  in
  Piqirun.gen_record
    code
    [ _dtype
    ...
    ; _dcomplex_val
    ; _half_val
    ; _resource_handle_val
    ]

and gen__attr_value code x =
  let _list =
    Piqirun.gen_optional_field 1 gen__attr_value_list_value x.Attr_value.list
  in
  ...
  Piqirun.gen_record
    code
    [ _list; _s; _i; _f; _b; _type_; _shape; _tensor; _placeholder; _func ]
...
and gen__attr_value_list_value code x =
  ...
  let _i =
    Piqirun.gen_packed_repeated_field
      3
      packed_gen__protobuf_int64
      x.Attr_value_list_value.i
  in
  let _f =
    Piqirun.gen_packed_repeated_field 4 packed_gen__float32 x.Attr_value_list_value.f
  in
  let _b =
    Piqirun.gen_packed_repeated_field 5 packed_gen__bool x.Attr_value_list_value.b
  in
  let _type_ =
    Piqirun.gen_packed_repeated_field
      6
      packed_gen__data_type
      x.Attr_value_list_value.type_
  in
  let _shape =
    Piqirun.gen_repeated_field 7 gen__tensor_shape_proto x.Attr_value_list_value.shape
  in
  let _tensor =
    Piqirun.gen_repeated_field 8 gen__tensor_proto x.Attr_value_list_value.tensor
  in
  let _func =
    Piqirun.gen_repeated_field 9 gen__name_attr_list x.Attr_value_list_value.func
  in
...
and gen__name_attr_list code x =
  ...
  let _attr =
    Piqirun.gen_repeated_field 2 gen__name_attr_list_attr_entry x.Name_attr_list.attr
  in
...
and gen__name_attr_list_attr_entry code x =
  ...
  let _value =
    Piqirun.gen_optional_field 2 gen__attr_value x.Name_attr_list_attr_entry.value
  in
...
and gen__op_def code x =
  ...
  let _output_arg =
    Piqirun.gen_repeated_field 3 gen__op_def_arg_def x.Op_def.output_arg
  in
  ...
  let _deprecation =
    Piqirun.gen_optional_field 8 gen__op_deprecation x.Op_def.deprecation
  in
  ...
  let _is_commutative =
    Piqirun.gen_optional_field 18 gen__bool x.Op_def.is_commutative
  in
  let _allows_uninitialized_input =
    Piqirun.gen_optional_field 19 gen__bool x.Op_def.allows_uninitialized_input
  in
  Piqirun.gen_record
    code
    [ _name
...
and gen__op_def_arg_def code x =
  ...
  let _number_attr =
    Piqirun.gen_optional_field 5 gen__string x.Op_def_arg_def.number_attr
  in
  let _type_list_attr =
    Piqirun.gen_optional_field 6 gen__string x.Op_def_arg_def.type_list_attr
  in
  let _is_ref = Piqirun.gen_optional_field 16 gen__bool x.Op_def_arg_def.is_ref in
  Piqirun.gen_record
    code
    [ _name; _description; _type_; _type_attr; _number_attr; _type_list_attr; _is_ref ]
...
and gen__op_def_attr_def code x =
  ...
  let _default_value =
    Piqirun.gen_optional_field 3 gen__attr_value x.Op_def_attr_def.default_value
  in
  let _description =
    Piqirun.gen_optional_field 4 gen__string x.Op_def_attr_def.description
  in
  let _has_minimum =
    Piqirun.gen_optional_field 5 gen__bool x.Op_def_attr_def.has_minimum
  in
  let _minimum =
    Piqirun.gen_optional_field 6 gen__protobuf_int64 x.Op_def_attr_def.minimum
  in
  let _allowed_values =
    Piqirun.gen_optional_field 7 gen__attr_value x.Op_def_attr_def.allowed_values
  in
  Piqirun.gen_record
    code
    [ _name
...
and gen__op_deprecation code x =
  let _version =
    Piqirun.gen_optional_field 1 gen__protobuf_int32 x.Op_deprecation.version
  in
  let _explanation =
    Piqirun.gen_optional_field 2 gen__string x.Op_deprecation.explanation
  in
...
and gen__data_type code x =
  Piqirun.int32_to_signed_varint
    code
    (match x with
    | `dt_invalid -> 0l
    | `dt_float -> 1l
...
and default_tensor_shape_proto () =
  { Tensor_shape_proto.dim = []; Tensor_shape_proto.unknown_rank = None }

and default_tensor_shape_proto_dim () =
  { Tensor_shape_proto_dim.size = None; Tensor_shape_proto_dim.name = None }
...
and default_name_attr_list () = { Name_attr_list.name = None; Name_attr_list.attr = [] }

and default_name_attr_list_attr_entry () =
  { Name_attr_list_attr_entry.key = None; Name_attr_list_attr_entry.value = None }
...
and default_op_deprecation () =
  { Op_deprecation.version = None; Op_deprecation.explanation = None }

and default_op_list () = { Op_list.op = [] }
